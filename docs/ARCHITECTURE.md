...
```text
src/
  DeltaZulu.Agent.Domain/        Source events, resource records, delivery records, profiles, serialization helpers, observations.
  ...
  DeltaZulu.Agent.Outputs.Ndjson/ NDJSON console/file sinks and error records.
