...
| [0006](0006-input-materialization-and-relp-ownership.md) | Accepted; transport scope narrowed by 0011 | Acquisition/materialization boundaries and RELP ownership for the current transitional transport. |
...
| [0011](0011-deltazulu-forward-transport.md) | Accepted | Transport naming and design: DeltaZulu.Forward, a RELP-derived, non-wire-compatible protocol owned by Pipeline. |
